...
/**
 * This node is used to test the slave API externally using integration tests in the test_ros package.
 * 
 * cd test_ros/test/client_verification/
 * ./test_slave_api.py  --text --profile=rosjava_profile.yaml
 * 
 * @author kwc
 *
 */
public class SlaveApiTestNode {
  ...
  public static void main(java.lang.String[] argv) throws RosInitException, RosNameException {
    ...
    Publisher<org.ros.message.std.String> pub_string = node.createPublisher("chatter_out", org.ros.message.std.String.class);
	...
	//Subscriber<org.ros.message.std.String> sub_string = node.createSubscriber("chatter_in", chatter_cb , org.ros.message.std.String.class);
	...
	// don't do any performance optimizations here, want to make sure that gc/etc... is working.
    while (true) {
