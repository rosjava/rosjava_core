...
public class MapSerializer extends TypeSerializerImpl {
    ...
    protected void writeEntry(ContentHandler pHandler, Object pKey, Object pValue) throws SAXException {
		pHandler.startElement(XmlRpcConstants.EMPTY_STRING, MEMBER_TAG, MEMBER_TAG, ZERO_ATTRIBUTES);
		pHandler.startElement(XmlRpcConstants.EMPTY_STRING, NAME_TAG, NAME_TAG, ZERO_ATTRIBUTES);
		...
		pHandler.endElement(XmlRpcConstants.EMPTY_STRING, NAME_TAG, NAME_TAG);
		writeValue(pHandler, pValue);
		pHandler.endElement(XmlRpcConstants.EMPTY_STRING, MEMBER_TAG, MEMBER_TAG);
	}
    ...
    public void write(final ContentHandler pHandler, Object pObject) throws SAXException {
		...
		pHandler.startElement(XmlRpcConstants.EMPTY_STRING, STRUCT_TAG, STRUCT_TAG, ZERO_ATTRIBUTES);
		writeData(pHandler, pObject);
		pHandler.endElement(XmlRpcConstants.EMPTY_STRING, STRUCT_TAG, STRUCT_TAG);
